...
%Take out the csf and wm regressors
%Put those in a csfwm_ORIGINALFILENAME.txt file in the same folder of the original file
...
%Ineke Pillet, marc 2021, version 1
%% THE ACTUAL CODE: 
...
for run = 1:numfiles
    ...
    csfwm_param=[confounds.csf,confounds.white_matter]; %we take out the six parameters
    ...
    finalnewname=['csfwm_' newfilename '.txt']; %like SPM we put rp_ in front and make it a txt file
    save(finalnewname,'csfwm_param','-ascii') %we save the param in a txt file in the folder
    clear confounds csfwm_param newfilename finalnewname
end
clear numfiles run confoundfilenames confoundfiles
end
